...
## ⚠️ ВАЖНО: Исправление ошибки загрузки

Если при загрузке .txt файлов возникает ошибка, следуйте инструкции:
📖 **[НАЧНИТЕ_ЗДЕСЬ.md](./НАЧНИТЕ_ЗДЕСЬ.md)** - пошаговое исправление (15-20 минут)

---

## О проекте

SP-Агент — это AI-помощник на базе Gemini 2.5 Flash, использующий технологию RAG (Retrieval-Augmented Generation) для поиска и предоставления информации из любых загруженных документов СП. 
...
В Supabase Dashboard → Settings → Edge Functions → Secrets добавьте переменные окружения:

```env
JINA_API_KEY=jina_...           # Получить на https://jina.ai
LOVABLE_API_KEY=lovable_...     # Получить на https://lovable.dev
SUPABASE_URL=https://your-project.supabase.co
SUPABASE_SERVICE_ROLE_KEY=your-service-role-key
```

### 🔧 Важно: Исправление ошибки загрузки

Если при загрузке .txt файлов возникает ошибка "Edge Function returned a non-2xx status code", выполните следующие шаги:

1. **Применить миграцию базы данных** - обновить размерность векторов
2. **Настроить JINA_API_KEY** - добавить API ключ в секреты Edge Functions
3. **Переразвернуть функции** - применить изменения

📖 **Подробная инструкция:** [БЫСТРОЕ_ИСПРАВЛЕНИЕ.md](./БЫСТРОЕ_ИСПРАВЛЕНИЕ.md)
...
### AI/ML:
- **Gemini 2.5 Flash** (via Lovable AI) - Large Language Model
- **Jina AI Embeddings v3** - Text embeddings для векторного поиска
